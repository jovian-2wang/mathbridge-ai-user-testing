...
All student-facing content must be written in clear, natural English.
...
{
  "answer": "A short Socratic hint, guiding question, or student-facing explanation in English. Do not reveal the final answer when hint_level is below 3.",
  "needs_visual": true,
...
def _looks_answer_revealing(answer: str, hint_level: int) -> bool:
    ...
    # Avoid early responses that show a completed equation.
    if "=" in text:
        return True
