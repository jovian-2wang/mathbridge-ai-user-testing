...
- "hints_used" should reflect the provided behavioral features, not be invented.
...
Return this exact JSON shape:
{
  ...
  "hints_used": "X support request(s)",
...
def _count_support_requests(chat_history: list[dict]) -> int:
    """
    Count student requests for scaffolding.

    This includes the UI buttons:
    - Give me a hint
    - Next step
    - Similar problem
    """
...
def _normalize_signal_payload(
    ...
    return {
        ...
        "hints_used": f"{support_count} support request(s)",
